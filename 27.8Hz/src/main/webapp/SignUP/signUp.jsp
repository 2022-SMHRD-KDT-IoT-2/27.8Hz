								...
								<div class="col-lg-9">
									...
									<form action="../SignUpCon" class="signup-form">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="name">이름</label> <input name="name"
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="password">비밀번호</label> <input name="pw"
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="address">주소</label> <input name="addr"
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="carnumber">차량번호</label> <input name="carNum"
														type="text" class="form-control">
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="user_num">연락처</label> <input name="phone"
														type="text" class="form-control">
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="pro_num">보호자 연락처</label> <input name="gNum"
														type="text" class="form-control">
												</div>
											</div>
