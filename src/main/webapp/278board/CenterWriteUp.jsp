                                        ...
                                        <form action="../CenterWriteUpCon.do" id="writeForm" name="writeForm"  method="post" enctype="application/x-www-form-urlencoded">
											<header class="major">
												<p>
													...
													<input id="centerTitle" name="centerTitle" type="text" value="<%=cvo.getQ_title() %>">
												</p>
												<p
													style="text-align: left; margin-bottom: 1%; margin-top: -1.75em;">작성자 : <%=writer%></p>
											</header>
											<hr style="margin-top: 0;">

											<div style="margin-top: 3%;">
												<textarea name="centerContent" style="resize: none;" rows="20" id="centerContent"><%=cvo.getQ_content() %></textarea>
											</div>
